...
object UserActor {
  ...
  object Event {
    ...
    case class UserJoined(username: String, actor: ActorRef)(implicit datetime: DateTime) extends Event(datetime)
    case class UserLeft(username: String)(implicit datetime: DateTime) extends Event(datetime)
    case class UserSentMessage(username: String, message: String)(implicit datetime: DateTime) extends Event(datetime)
  }
}
